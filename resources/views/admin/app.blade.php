		...
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="index.html">
                    <span class="align-middle">Koa2 - Admin</span>
                </a>
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src="https://cdn.koa2.ro/avatar.gif" class="avatar img-fluid rounded-circle me-1" alt="Charles Hall" /> <span class="text-dark">{{ Auth::user()->login }}</span>
                            </a>
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="{{ route('app.user') }}"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
								<div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('app.home') }}"><i class="align-middle me-1" data-feather="arrow-left"></i> Back to homepage</a>
								<div class="dropdown-divider"></div>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>Koa2</strong></a> - <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>Admin Board</strong></a>								&copy;
							</p>
						</div>
					</div>
				</div>
