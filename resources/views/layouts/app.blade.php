...
<div class="right-navbar" id="mobile_navbar">
    ...
    <ul class="list-unstyled m-0 text-center">
        <li>
            <a class="navbar-text text-decoration-none" href="#">HOME</a>
        </li>
        <li>
        ...
        <li>
            @if(Auth::user())
            <button type="button" class="btn btn-koa me-2">{{ Auth::user()->login }}</button>
            @else
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="footer-navs">
                    <ul class="list-unstyled d-flex gap-4 m-0">
                        <li><a class="navbar-text text-decoration-none" href="#">HOME</a></li>
